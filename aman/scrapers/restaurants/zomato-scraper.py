...
def scrape_zomato_3pass():
    ...
    with AREA_PASS_CSV.open("w", newline="", encoding="utf-8") as file:
        ...
        with sync_playwright() as p:
            ...
            browser.close()
            print(f"\nArea-specific scraping complete! File saved: {AREA_PASS_CSV}")
    ...
    with MASTER_CSV.open("w", newline="", encoding="utf-8") as master_file:
    ...
    print(f"Master deduplicated file saved: {MASTER_CSV}")
